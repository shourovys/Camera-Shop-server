...
authController.makeAdmin = async (req, res) => {
  try {
    ...
    console.log(
      '🚀 ~ file: AuthController.js ~ line 99 ~ authController.makeAdmin= ~ email',
      email
    );
    ...
    console.log('🚀 ~ file: AuthController.js ~ line 109 ~ authController.makeAdmin= ~ data', data);
    res.json({ success: true });
  } catch (error) {
    console.log(
      '🚀 ~ file: AuthController.js ~ line 107 ~ authController.makeAdmin= ~ error',
      error,
    );
  }
};
